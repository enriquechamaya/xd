...
<html>
  ...
  <body onload="cargar();">
              ...
              <fieldset>
                ...
                <div class="collapse in" id="demo5">
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="display-block text-uppercase text-semibold">Cantidad de documentos adjuntos</label>
                        <span id="lblCantidadDocumentos" class="label border-left-blue-800 label-striped text-light fix-label"></span>
                      </div>
                    </div>
                    <div class="col-md-9">
                      <div class="form-group">
                        <label class="display-block text-uppercase text-semibold">Enlace expedientes</label>
                        <a href="https://www.google.com.pe" target="_blank" id="lblEnlaceAlfresco" style="text-transform: initial" class="label border-left-blue-800 label-striped text-light fix-label"></a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script src="../js/pages/aprobacionFichaDetalle.js" type="text/javascript"></script>
