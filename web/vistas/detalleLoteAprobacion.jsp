...
<html lang="en">
  ...
  <body onload="cargar();">
    ...
    <!--contenido-->
    <form action="../LoteAprobacionServlet" method="post" id="formFichasAprobadas" target="_blank">
      <input type="hidden" name="accion" value="imprimirFichasAprobadas" />
    </form>
    <div class="row">
      <div class="col-md-12">
        <div class="panel so-card-2">
          <div class="panel-heading bg-blue-800">
            ...
            <div class="heading-elements">
              <button type="button" class="btn btn-success btn-lg" id="btnImprimirFichasAprobadas">
    ...
    <script src="../js/pages/detalleLoteAprobacion.js" type="text/javascript"></script>
