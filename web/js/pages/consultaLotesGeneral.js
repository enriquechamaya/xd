        ...
        columns: [
          ...
          },
          {
            ...
            render: (data, type, row) => {
              return data === 'A' ? `<span class="label bg-blue">ADMINISTRATIVO</span>` : `<span class="label bg-green">DOCENTE</span>`;
            }
          },
          {
            data: 'numeroFichas',
          ...
          },
          {
            ...
            className: 'text-center',
            render: (data, type, row) => {
              return `<span class="${data.estilo}">${data.estadoLote}</span>`;
            }
          },
          {
            data: null,
...
let DOMEvents = () => {
  $('#tblLotes tbody').on('click', '.verDetalle', (e) => {
    ...
    lote.obtenerDetalleLote({codigoLote: rowData.codigoFichaLote, tipoLote: rowData.tipoLote})
      .then(data => {
        if (data.status) {
...
lote.listarFichasPresidenciaDT()
DOMEvents()
formFiltroLotes.initValidateForm()
formFiltroLotes.initRulesForm()
formFiltroLotes.actionFormChange()
window.name = ''